<div class="navbar-custom">
    <ul class="list-unstyled topbar-right-menu float-right mb-0">
        ...
        <li class="dropdown notification-list show">
            ...
            <div
                class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu profile-dropdown show"
                style="position: absolute; transform: translate3d(10px, 70px, 0px); top: 0px; left: 0px; will-change: transform;"
